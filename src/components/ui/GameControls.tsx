	...
	return (
		<div className="bg-stone-950 p-6 rounded-lg shadow-lg">
			<div className="flex items-center justify-between mb-4">
				<div className="text-lg font-sans">Rolls Left: {rollsLeft}</div>
				<button
					onClick={handleRoll}
					disabled={rollsLeft === 0 || isRolling}
					className="bg-red-900 text-white px-6 py-2 rounded-lg flex items-center gap-2 disabled:opacity-50"
				>
